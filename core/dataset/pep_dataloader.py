...
from core.utils.misc import load_config
...
# testset
names = []
with open('./data/processed/names.txt','r') as f:
    for line in f:
...
if __name__ == '__main__':
    ...
    dataset = PepDataset(structure_dir = "./data/crude/", dataset_dir = "./data/processed",
